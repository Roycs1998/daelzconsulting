...
date_default_timezone_set("America/Lima");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($celular) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $recipient = "sistemas@ebalsconsultores.com , roycarisarmiento@gmail.com";

        // Build the email content.
        $email_content = '<html>
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css" integrity="sha384-/Y6pD6FV/Vv2HJnA6t+vslU6fwYXjCFtcEpHbNJ0lyAFsXTsjBbfaDjzALeQsN6M" crossorigin="anonymous">
	<div align="center">
	<div align="center"><img src="http://daelzconsulting.com.pe/images/daelz-color.png" style="width:250px;" ></div>
	<div>
	<h3><b>NUEVO MENSAJE DESDE LA PAGINA WEB</b></h3>
		...
		<div><h3>Datos de la consulta</h3>
		    <table class="tabla_precios" >
                ...
                <tr>
                  <th colspan="2"  style="text-align: -webkit-center; ">Celular</th>
    ...
    $headers .= "From: DAELZ\r\n";
        ...
        $email_headers = "DAELZ - Consulta Web: $message";
