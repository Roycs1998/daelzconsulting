...
if ($ubicacion_actual == "productos.php") {
  $productos = "active";
}
...
<div class="ie-panel"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="images/ie8-panel/warning_bar_0000_us.jpg" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
    ...
    <div class="page text-center text-md-left"><a class="section section-banner d-none d-xl-flex"  srcset="images/banner/foreground-04-1600x60.png 1x, images/banner/foreground-04-3200x120.png 2x" alt="" width="1600" height="310"></a>
      <!-- Page Header-->
<header class="page-head">
        <div class="rd-navbar-wrap">
          <nav class="rd-navbar rd-navbar-secondary" data-stick-up-clone="true" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed" data-md-layout="rd-navbar-static" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-static" data-lg-stick-up-offset="252px">
            <div class="rd-navbar-inner"><span class="small">¡Bienvenidos a nuestro portal de soluciones integrales!</span>
              <ul class="list-inline list-inline-lg offset-top-0">
                <li><a class="ioon icon-sm icon-silver-chalice fa-facebook"  href="https://www.instagram.com/dprotec.epp/" target="_blank"></a></li>

                <li><a class="ioon icon-sm icon-silver-chalice fa-instagram" href="https://www.facebook.com/DprotecOficial" target="_blank"></a></li>
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img class="brand-device" src="images/logo-dprotec.png" width="229" height="58" alt="Home service"><img class="brand-mobile" src="images/logo-dprotec-blanco.png" width="229" height="58" alt="Home service"></a></div>
              </div>
                    ...
                    <li>
                      <div class="unit flex-row unit-spacing-xs">
                        ...
                        <div class="unit-body">
                          ...
                          <h6><a href="tel:#">(+51) 957 404 672<br> (+51) 981 453 402</a></h6>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="unit flex-row unit-spacing-xs">
                        ...
                        <div class="unit-body">
                          <div class="title"><span class="small">Oficina</span></div>
                          <h6><a href="#">Av. Las Camelias 790, distrito de San Isidro</a></h6>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="unit flex-row unit-spacing-xs">
                        ...
                        <div class="unit-body">
                          <div class="title"><span class="small">Horario de atención</span></div>
                          <h6>Lunes - Viernes : 09:00 - 18:00 <br>Sabado: 09:00 - 12:00</h6>
                        </div>
                      </div>
                    </li>
                  </ul>
            ...
            <div class="rd-navbar-inner">
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                  <li class="<?php echo $inicio;?>"><a class="alto_nav" href="inicio.php">Inicio</a></li>
                  <li class="<?php echo $nosotros;?>"><a class="alto_nav"href="nosotros.php">Nosotros</a></li>
                  <li class="<?php echo $productos;?>"><a class="alto_nav" href="productos.php">Productos</a></li>
                  <li class="<?php echo $servicios;?>"><a class="alto_nav" href="servicios.php">Servicios</a></li> 
                  <li class="<?php echo $contacto;?>"><a class="alto_nav" href="contacto.php">Contactanos</a></li>
                  <li><a href="productos.php"><i class="fa-solid fa-cart-shopping" style="font-size: 25px;"></i></a></li>
